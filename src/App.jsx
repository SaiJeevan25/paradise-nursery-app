	...
	return (
		<Router>
			<Routes>
				...
				<Route path='/cart' element={<CartPage setCartQuantity={setCartQuantity} setCartItems={setCartItems}  cartQuantity={cartQuantity} cartItems={cartItems} removeFromCart={removeFromCart} singleItem={singleItem}/>}></Route>
			</Routes>
		</Router>
	)
}
